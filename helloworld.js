...
function hideSuggestions(element) {
    ...
    message.style = "font-size: 50px; color: #777; text-align: center; font-family: Times New Roman;"
...
function unhideSuggestions(element, n) {
    ...
    message.style = "font-size: 30px; color: #777; text-align: center; font-family: Times New Roman;";
